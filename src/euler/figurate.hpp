 ...
 *
 * There are special names for polygonal numbers with 3 to 10 sides (and more):
 * triangular, square, pentagonal, hexagonal, heptagonal, octagonal, nonagonal, 
 * and decagonal.
 *
 ...
 * @param r Rank of polygonal to check.
 * @param n An integer to check.
 * @returns @c true if @c n is an <code>r</code>-gonal number, 
 *      @c false otherwise.
 * @complexity Constant.
 *
 * @ingroup Figurate
